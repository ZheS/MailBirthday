					...
					<table width="800px" border="0" align="center" cellpadding="2"
						...
						<tbody>
							<s:iterator value="sendMessages" status="status">
								<tr>
									<td class="table_td"><s:property
											value="employees[#status.index].name"></s:property></td>
									<td class="table_td"><s:property
											value="employees[#status.index].email"></s:property></td>
									<td class="table_td"><s:property
											value="sendMessages[#status.index].memo"></s:property></td>
								</tr>
							</s:iterator>
						</tbody>
					</table>
