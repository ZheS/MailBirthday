		...
		<div id="content">
			...
			<table width="800px" border="0" align="center" cellpadding="2"
				...
				<s:if test="corporations.size > 0">
					...
					<tbody>
						<s:iterator value="corporations" status="status">
							<tr>
								...
								<td class="table_td"><s:hidden id="corporationId"
										value="id" /><input type="button" value="编辑"
									onclick="window.location.href = 'modifyCorporation.action?id=<s:property value="id" />'" /><input
									type="button" value="删除"
									onclick="delete_confirm('deleteCorporation.action?id=<s:property value="id" />')" /></td>
							</tr>
						</s:iterator>
					</tbody>
					<s:if test="count>10">
						<tr>
							<td class="table_td" colspan="3">
								<div style="font-size: 13px;">
									...
									<a id="pre" href="viewCorporation.action?page=${page-1}">上一页</a>
									， <a id="next" href="viewCorporation.action?page=${page+1}">下一页</a>
