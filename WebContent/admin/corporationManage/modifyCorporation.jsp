...
<script type="text/javascript">
	function sub(actionName) {
		if (confirm("您确认要修改吗？")) {
			var form = document.getElementById("modifyCorporationExcute");
...
<body>
	<div id="container" class="div_main">
		...
		<div id="content">
			<h3 style="text-align: center;">编辑下属企业</h3>
			<s:form theme="simple" id="modifyCorporationExcute">
				<s:hidden name="id" value="%{corporation.id}" />
