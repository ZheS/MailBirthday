...
<script type="text/javascript">
	function sub(actionName) {
		if (confirm("您确认要修改吗？")) {
			var form = document.getElementById("modifyLoginUserExcute");
...
<body>
	<div id="container" class="div_main">
		...
		<div id="content">
			<h3 style="text-align: center;">编辑后台账户</h3>
			<s:form theme="simple" id="modifyLoginUserExcute">
				<s:hidden name="id" value="%{loginUser.id}" />
				<table width="30%" border="0" align="center" cellpadding="2"
					...
					<tr>
						<td class="table_td" style="text-align: right;">新密码：</td>
						<td class="table_td" style="text-align: left;"><s:password /></td>
					</tr>
					<tr>
						<td class="table_td" style="text-align: right;">确认新密码：</td>
					...
					<tr>
						<td class="table_td" colspan="8" align="center"><input
							type="button" value="修改信息" onclick="sub('modifyLoginUserExcute')">
							<input type="button" value="返回"
							onclick="window.location.href='viewLoginUser.action'"></td>
					</tr>
				</table>
			</s:form>
		</div>
